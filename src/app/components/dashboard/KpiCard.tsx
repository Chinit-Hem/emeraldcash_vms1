...
export default function KpiCard({ label, value, sublabel, accent = "green", onClick }: KpiCardProps) {
  return (
    <div
      className={`ec-glassPanelSoft rounded-2xl p-4 ring-1 ring-black/5 border-l-4 ${accentClasses(accent)} ${
        onClick ? "cursor-pointer transition-all hover:bg-gray-50 hover:shadow-md active:scale-[0.98]" : ""
      }`}
      onClick={onClick}
    >
